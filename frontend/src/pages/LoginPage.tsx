        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
          <div className="bg-white rounded-xl shadow-md flex w-full max-w-5xl overflow-hidden">
            ...
            <div className="w-full md:w-1/2 p-8 md:p-12">
              <h2 className="text-2xl font-bold mb-6">Đăng nhập <span className="text-gray-500">(Dành cho Admin)</span></h2>
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <label className="block text-sm font-medium mb-1">Nhập username</label>
                  <input
                    type="text"
                    placeholder="Nhập username của bạn tại đây..."
